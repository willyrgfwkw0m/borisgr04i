 ...
 * @author borisgr04
 */
@WebServlet(name = "EPS_NuevaNegacion", urlPatterns = {"/EPS_NuevaNegacion"})
public class EPS_NuevaNegacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        final Negacion o = gson.fromJson(json, Negacion.class);
