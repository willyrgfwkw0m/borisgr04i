...
public class RepIPS {
    ...
    private RepIPS() {
        add(new IPS("IPS01","HOSPITAL PRIMER NIVEL","12345","0912347898","Calle 9 No. 22-75","http://localhost:9090/hapi-fhir-ips-s/fhir/","S"));
        add(new IPS("IPS02","LABORATORIO CLÍNICO","54321","0912347898","Calle 12 No. 54-75","http://localhost:9090/hapi-fhir-ips-r/fhir/","R"));
        add(new IPS("IPS03","CLINICA MEDIANA Y ALTA COMPLEJIDAD","67890","0912347898","Calle 54 No. 23-75","http://localhost:9090/hapi-fhir-ips/fhir/","RS"));
    }
