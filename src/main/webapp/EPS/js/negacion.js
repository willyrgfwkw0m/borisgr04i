var manejador = (function () {
    ...
    var _addHandlers = function () {
        ...
        $("#btnLitoDetalleNegacion").click(function () {
            _ActualizarCups();
        });
    };
    var _ActualizarCups = function () {
        lServiciosCUPS[indexCupsActual].justificacion = $("#txtJustificacion").val();
        lServiciosCUPS[indexCupsActual].fundamentoLegal = $("#txtFundamentoLegal").val();
        lServiciosCUPS[indexCupsActual].alternativa = $("#txtAlternativa").val();
    };
    ...
    var formToJSON = function () {
        return JSON.stringify({
            ...
            "ips_ide": Documento.ips_ide,
            "eps_id": Documento.eps_id,
            "pac_ide": Documento.pac_ide,
    ...
    var _EjemploPOST = function () {
        $.ajax({
            url: '/hapi-fhir-eps/EPS_NuevaNegacion',
            dataType: 'json',
            data: formToJSON(),
            type: 'POST',
            cache: false,
    ...
    return {
        ...
        AgregarDetalleCups: function (index) {
            indexCupsActual = index;
            $("#txtJustificacion").val(lServiciosCUPS[index].justificacion);
            $("#txtFundamentoLegal").val(lServiciosCUPS[index].fundamentoLegal);
            $("#txtAlternativa").val(lServiciosCUPS[index].alternativa);
