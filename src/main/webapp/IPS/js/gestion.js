var manejador = (function () {
    ...
    var _addHandlers = function () {
        ...
        $("#btnIrAcuseReciboAutorizacion").click(function () {
            if (DocumentoActual != null) window.location.href = "AcuseReciboAutorizacion.html?NumDoc=" + DocumentoActual.idDocumento;
        });
        $("#btnIrAcuseReciboNegacion").click(function () {
            if (DocumentoActual != null) window.location.href = "AcuseReciboNegacion.html?NumDoc=" + DocumentoActual.idDocumento;
        });
    };
    ...
    var _traerDocumentos = function () {
        $.ajax({
            url: '/hapi-fhir-ips/svDocumentos',
            dataType: 'json',
            data: null,
            type: 'GET',
            cache: false,
    ...
    var _traerEstadosDocumentos = function () {
        $.ajax({
            url: '/hapi-fhir-ips/svGetSolicitudesGE',
            dataType: 'json',
            data: null,
            type: 'GET',
            cache: false,
    ...
    var verDetallesDocumentoAutorizacion = function (item) {
        ...
        $.each(item.lServiciosCUPS, function (index, item) {
            var i = index + 1;
            $("#tblCupsAut").append("<tr><th scope='row'>" + i + "</th><td>" + item.CodigoCUPS + "</td><td>" + item.Cantidad + "</td><td>" + item.Descripcion + "</td></tr>");
        });
    ...
    var verDetallesDocumentoArAutorizacion = function (item) {
        ...
        item.RespuestaSolicitud = item.estado;
        item.FechaRespuestaSolicitud = item.rptaSolicitud.acuseRecibo.fechaDocumento;
