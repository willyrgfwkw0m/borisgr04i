var manejador = (function () {
    ...
    var formToJSON = function () {
        return JSON.stringify({
            "idDocRecibido": Documento.rptaSolicitud.idDocumento
        });
    };
    var _EjemploPOST = function () {
        $.ajax({
            url: '/hapi-fhir-ips/IPS_ARAutorizacion2',
            dataType: 'json',
            data: formToJSON(),
            type: 'POST',
            cache: false,
    ...
    var _traerDocumento = function () {
            $.ajax({
                url: '/hapi-fhir-ips/svDoc?id=' + NumeroDocumento,
                dataType: 'json',
                data: null,
                type: 'GET',
                cache: false,
                ...
                success: function (result) {
                    ...
                    $("#codigo_ips").html(Documento.ips.Codigo);
